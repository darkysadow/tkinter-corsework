...
def whatistkinter():
    ...
    swin = ScrolledWindow(mainframe, width=600, height=820)
    swin.pack()
    win = swin.window
...
root.mainloop()
    ...
    def example():
        ...
        Label(app, text='Пункт видачі', font=("Arial", 18)).pack()  # Так як ця мітка не прив'язана до змінної, розмістити її
        # потрібно одразу через вказання .pack() в кінці

        button = Button(app, text='Отримати', command=take)  # "command=take" - звернення до функції take() при натисканні
        label = Label(app, width=10, height=1)  # пуста мітка, розмірами 10х1, яка буде запонена при натисканні на кнопку
...
root.mainloop()
    ...
    def example():
        ...
        def open_file():
            f1 = open(str(entry.get()), encoding="utf-8")
            text.insert(1.0, f1.read())

        def save_file():
            s = text.get(1.0, END)
            f1 = open(str(entry.get()), "w+", encoding="utf-8")
            f1.write(s)

        app = Tk()
        Label(app, text="Вкажіть шлях до файлу:").pack()
        frame = Frame(app)

        entry = Entry(frame, width=50)

        open_button = Button(frame, width=10, text='Відкрити', command=open_file)
        save_button = Button(frame, width=10, text='Зберегти', command=save_file)

        frame.pack(anchor=NW, ipadx=10, ipady=10, padx=10, pady=6)
        entry.pack(side=LEFT, padx=10)
        open_button.pack(side=LEFT)
        save_button.pack(side=LEFT, padx=10)

        text = Text(app, width=140, height=35)
        text.pack(side=LEFT)

        scroll = Scrollbar(app, command=text.yview)
        scroll.pack(side=LEFT, fill=Y)
...
...
                                """, bg="black", bd=3, relief=GROOVE, fg="green", justify=LEFT, font=codeFont).pack()
    image = ImageTk.PhotoImage(file="images/window/1.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
    ...
    ...
                                    """, bg="black", bd=3, relief=GROOVE, fg="green", justify=LEFT,
          font=codeFont).pack()
    image = ImageTk.PhotoImage(file="images/window/2.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
...
def gridLesson():
    ...
    Label(win, text=text, font=('Trebuchet MS', 12), justify=LEFT).pack()
    del text
    image = ImageTk.PhotoImage(file="images/grid/1.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
    ...
    Label(win, text=text, font=('Trebuchet MS', 12), justify=LEFT).pack()
    del text
    image = ImageTk.PhotoImage(file="images/grid/5.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
...
root.mainloop()
    ...
    Label(win, text=text, font=('Trebuchet MS', 12), justify=LEFT).pack()
    del text
    image = ImageTk.PhotoImage(file="images/grid/2.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
...
root.mainloop()
    ...
    image = ImageTk.PhotoImage(file="images/grid/4.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
...
root.mainloop()
                """, bg="black", bd=3, relief=GROOVE, fg="green", justify=LEFT, font=codeFont).pack()
    image = ImageTk.PhotoImage(file="images/messageBox/1.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
    image = ImageTk.PhotoImage(file="images/messageBox/2.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
    image = ImageTk.PhotoImage(file="images/messageBox/3.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
...
root.mainloop()
            """, bg="black", bd=3, relief=GROOVE, fg="green", justify=LEFT, font=codeFont).pack()
    image = ImageTk.PhotoImage(file="images/messageBox/7.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
...
...
            """, bg="black", bd=3, relief=GROOVE, fg="green", justify=LEFT, font=codeFont).pack()
    image = ImageTk.PhotoImage(file="images/menu/1.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
...
...
    """, bg="black", bd=3, relief=GROOVE, fg="green", justify=LEFT, font=codeFont).pack()
    image = ImageTk.PhotoImage(file="images/menu/3.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
...
...
    """, bg="black", bd=3, relief=GROOVE, fg="green", justify=LEFT, font=codeFont).pack()
    image = ImageTk.PhotoImage(file="images/menu/4.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
...
root.mainloop()
        """, bg="black", bd=3, relief=GROOVE, fg="green", justify=LEFT, font=codeFont).pack()
    image = ImageTk.PhotoImage(file="images/menu/5.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
    ...
    Label(win, text=text, font=('Trebuchet MS', 12), justify=LEFT).pack()
    del text
    image = ImageTk.PhotoImage(file="images/menu/6.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
...
def placeLesson():
    ...
    Label(win, text=text, font=('Trebuchet MS', 12), justify=LEFT).pack()
    del text
    image = ImageTk.PhotoImage(file="images/place/1.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
...
root.mainloop()
    """, bg="black", bd=3, relief=GROOVE, fg="green", justify=LEFT, font=codeFont).pack()
    image = ImageTk.PhotoImage(file="images/place/2.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
    Label(win, text='Розтягуємо вікно, і бачимо, як другий віджет залежить від розмірів',
          font=('Trebuchet MS', 12), justify=LEFT).pack()
    image = ImageTk.PhotoImage(file="images/place/3.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
...
...
        """, bg="black", bd=3, relief=GROOVE, fg="green", justify=LEFT, font=codeFont).pack()
    image = ImageTk.PhotoImage(file="images/place/4.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
    Label(win, text='Розтягуємо вікно, і бачимо, як другий віджет залежить від розмірів',
          font=('Trebuchet MS', 12), justify=LEFT).pack()
    image = ImageTk.PhotoImage(file="images/place/5.gif")
    labelImage = Label(win, image=image)
    labelImage.image = image
    labelImage.pack(pady=10)
    del image, labelImage
